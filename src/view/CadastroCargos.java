...
public class CadastroCargos extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTextFieldNomeCargo, javax.swing.GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nome = jTextFieldNomeCargo.getText();
        String salarioTexto = jTextFieldSalario.getText();
        ...
        try {
            ...
            Cargo cargo = new Cargo(nome, salario);
            CargoDAO cargoDAO = new CargoDAO();
            cargoDAO.cadastrarCargo(cargo);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Salário inválido! Digite um valor numérico.");
        }
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroCargos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
